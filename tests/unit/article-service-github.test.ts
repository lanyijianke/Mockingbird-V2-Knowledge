...
const directoryFixture: ArticleDirectorySnapshot = {
    ...
    entries: [
        ...
        },
        {
            ...
            coverImagePath: 'articles/prompt-caching/images/cover.jpg',
            coverUrl: '/api/article-assets/ai/prompt-caching/images/cover.jpg',
            contentPath: 'articles/prompt-caching/index.md',
            contentFilePath: '/data/content/web-article/articles/prompt-caching/index.md',
        ...
        },
        {
            ...
            coverImagePath: 'articles/agent-loops/images/cover.jpg',
            coverUrl: '/api/article-assets/ai/agent-loops/images/cover.jpg',
            contentPath: 'articles/agent-loops/index.md',
            contentFilePath: '/data/content/web-article/articles/agent-loops/index.md',
